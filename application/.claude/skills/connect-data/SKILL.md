...
4. **Postgres (warehouse_db)** — "I have a Postgres (warehouse_db) database"
5. **Postgres/DuckDB** — "I have a Google Postgres/DuckDB dataset"
6. **Postgres/DuckDB** — "I have a Postgres/DuckDB warehouse"
...
**For Postgres (warehouse_db) / Postgres/DuckDB / Postgres/DuckDB:**
